...
// Like realloc, except abotrs the program if allocation fails.
extern void* xrealloc (void* ptr, size_t size);

// Like srtdup, except abotrs the program if allocation fails.
...
struct server_module {
    // The shared library handle corresponded to the loaded module.
    void* handle;
    // A name describing the module.
    const char* name;
    // The function that genertes the HTML results for this module.
