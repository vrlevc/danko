...
/**
 * HTML source for the start of the page we generating
 */
...
/**
 * HTML source for the end of the page we generating
 */
...
/**
 * HTML source for the page indicationg there was a problem 
 * opening /proc/issue.
 */
...
/**
 * HTML source indicationg an error.
 */
...
void module_generate (int fd)
{
    ...
    else 
    {
        ...
        if (rval == -1)
        {
            /* Something goes wrong sending the contents of proc/issue.
